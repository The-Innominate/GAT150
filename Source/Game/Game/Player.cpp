...
void Player::Update(float dt) {
	...
	//	if (weaponSelect == 2) {
	//		//Weapon 1
	//		kda::Transform transform1{transform.position, transform.rotation + kda::DegreesToRadians(5.0f), 1};
	//		std::unique_ptr<WeaponComponent> pew = std::make_unique<WeaponComponent>( 400.0f, transform1);
	//		pew->tag = "Player";
	...
	//		//Weapon 2
	//		kda::Transform transform2{transform.position, transform.rotation - kda::DegreesToRadians(5.0f), 1};
	//		std::unique_ptr<WeaponComponent> pew2 = std::make_unique<WeaponComponent>(400.0f, transform2);
	//		pew2->tag = "Player";
